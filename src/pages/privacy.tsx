export default () => (
  <>
    <h1>Privacy Policy of Schwannden Kuo</h1>

    <p>
      Schwannden Kuo operates the https://jethro.schwannden.com/ website, which provides the
      SERVICE.
    </p>

    <p>
      This page is used to inform website visitors regarding our policies with the collection, use,
      and disclosure of Personal Information if anyone decided to use our Service, the Jethro
      website.
    </p>
    ...
    <p>
      ...
      which is accessible at https://jethro.schwannden.com/, unless otherwise defined in this
      Privacy Policy.
    </p>
    ...
    <p>
      ...
      <a href="https://policies.google.com/privacy"></a> Google Service
    </p>
